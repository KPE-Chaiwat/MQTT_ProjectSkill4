...
#define  ID 1  // Modbus slave ID= 1

//SoftwareSerial mySerial(2, 3); // RX PIN 2 Uno, TX PIN 3 Uno
SoftwareSerial mySerial(16, 17); // RX PIN 16 Uno, TX PIN 17 Uno
#define MAX485_DE      5//4 //PIN 4 Uno
#define MAX485_RE_NEG  18//5 //PIN 5 Uno
...
void loop()
{
  ...
  Serial.println(Meta.ku8MBSuccess);
